                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors">
                                ...
                                <td class="px-4 py-3.5 text-right pr-4 whitespace-nowrap">
                                    <div class="inline-flex items-center justify-end gap-1.5">
                                        ...
                                        <button type="button" @click="deleteVoucher(jv.id)" class="p-2 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 hover:text-rose-700 transition inline-flex items-center justify-center shadow-xs cursor-pointer" title="Delete Voucher">
