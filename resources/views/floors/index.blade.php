                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-4 py-3 border text-right">
                                <div class="inline-flex items-center justify-end gap-1.5">
                                    ...
                                    <button @click="openEditModal({{ $floor->id }}, {{ $floor->floor_number }}, '{{ addslashes($floor->name) }}')" title="Edit Floor" class="p-2 rounded-lg bg-[#a38c29]/10 hover:bg-[#a38c29]/20 text-[#a38c29] hover:text-[#8a7522] transition inline-flex items-center justify-center shadow-sm">
                                    ...
                                    @if($floor->units_count === 0)
                                        <form action="{{ route('floors.destroy', $floor->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this floor level?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" title="Delete Floor" class="p-2 rounded-lg bg-[#a38c29]/10 hover:bg-[#a38c29]/20 text-[#a38c29] hover:text-[#8a7522] transition inline-flex items-center justify-center shadow-sm">
