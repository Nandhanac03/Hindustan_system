                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors text-xs font-semibold text-slate-700">
                            ...
                            <td class="px-4 py-3.5 border text-right">
                                <div class="inline-flex items-center justify-end gap-1.5">
                                    ...
                                    <button @click="openEditModal(bank)" class="p-2 rounded-lg bg-[#09876B]/10 hover:bg-[#09876B]/20 text-[#09876B] hover:text-[#076852] transition inline-flex items-center justify-center shadow-sm" title="Edit Bank">
                                    ...
                                    <button @click="deleteBank(bank.id)" class="p-2 rounded-lg bg-red-600/10 hover:bg-red-600/20 text-red-600 hover:text-red-700 transition inline-flex items-center justify-center shadow-sm" title="Delete Bank">
