                            ...
                            <tr class="hover:bg-slate-50 transition group">
                                ...
                                <td class="px-5 py-3 text-right">
                                    <div class="flex items-center justify-end gap-3">
                                        ...
                                        <button type="button" @click="openDeleteModal({{ $status->toJson() }})" class="p-2 rounded-xl transition-colors inline-flex items-center justify-center bg-rose-50 text-rose-600 hover:bg-rose-100 border border-rose-100" title="Delete">
