                ...
                <table id="reportsTable" class="w-full text-xs text-left">
                    <thead>
                        <tr class="bg-gradient-to-r from-[#a38c29] via-[#b89635] to-[#a38c29] text-white border-b-2 border-[#8a7522] text-[10px] font-black uppercase tracking-widest shadow-xs">
                            ...
                            <th class="px-5 py-3.5 text-white font-extrabold">Bank / Project</th>
                            <th class="px-5 py-3.5 text-white font-extrabold">EMI Installment</th>
                            <th class="px-5 py-3.5 text-right text-white font-extrabold">Principal</th>
                            <th class="px-5 py-3.5 text-right text-white font-extrabold">Interest</th>
                            <th class="px-5 py-3.5 text-right text-white font-extrabold">EMI Amount</th>
