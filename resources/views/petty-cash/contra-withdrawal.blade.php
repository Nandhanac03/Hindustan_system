            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <form action="{{ route('petty-cash.store-contra-withdrawal') }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <!-- Disburse From Bank Account (Searchable Select Box) -->
                        <div class="space-y-1.5 relative" @click.outside="bankDropdownOpen = false">
                            <label class="block text-xs font-bold text-slate-700 uppercase tracking-wide mb-1.5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="amount" x-model="amount" step="0.01" min="0.01" required data-no-words="true" 
                                       placeholder="0.00"
                            ...
                            <!-- Amount in Words (Theme Color Box) -->
                            <div x-show="amountInWordsText" 
                                 class="mt-2 px-3.5 py-2 bg-[#faf9f5] border border-[#a38c29]/40 rounded-xl text-xs font-bold text-[#8a7522] tracking-wide shadow-2xs flex items-center gap-2" 
                                 x-cloak>
