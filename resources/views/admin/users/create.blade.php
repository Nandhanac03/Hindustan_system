<x-erp-layout>
    ...
    <x-slot:headerTitle>User Directory / Create</x-slot:headerTitle>

    <div class="max-w-2xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-base font-bold text-slate-900 uppercase tracking-wide">Register New Employee</h2>
                <p class="text-xs text-slate-500 mt-0.5">Define role, base system, and credentials.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
            <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4">
                ...
                <!-- Password -->
                <div class="space-y-1.5">
                    <label for="password" class="text-[10px] font-bold text-slate-455 uppercase tracking-widest block">Password</label>
                    <input id="password" 
                           type="password" 
                           name="password" 
                           required 
