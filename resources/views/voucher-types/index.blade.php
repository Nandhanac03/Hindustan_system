                    ...
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-4 py-3.5 text-right pr-4 whitespace-nowrap">
                            <div class="inline-flex items-center justify-end gap-1.5">
                                ...
                                <button type="button" @click="openDeleteModalFn({{ json_encode($v) }})" class="p-2 rounded-lg bg-rose-50 hover:bg-rose-100 text-rose-600 transition inline-flex items-center justify-center shadow-xs" title="Delete Voucher Type">
