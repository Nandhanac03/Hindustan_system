                            ...
                            <tr class="hover:bg-slate-50 transition-colors font-semibold text-slate-700">
                                ...
                                <td class="px-5 py-4 text-right">
                                    <div class="inline-flex items-center justify-end gap-1.5">
                                        <!-- View Modal Button -->
                                        <button type="button" @click="openViewModal(@js($pm))" class="p-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 transition" title="View Details">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                        </button>

                                        <!-- Edit Modal Button -->
                                        <button type="button" @click="openEditModal(@js($pm))" class="p-2 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-[#a38c29] transition" title="Edit Mode">
